...
dat <- readRDS('../data_spatial/areas_df.rds') %>%
  mutate('Relative Size'=round(Relative.Size,3)) %>%
...
Information on the unfished distribution of Red Snapper and Gag is not available. Instead, the assumed unfished distribution was derived from various sources of information, including the CDNR Reef Fish Survey [@bubley2023] and studies reported in the literature.
...
Data from the SCDNR Reef Fish Survey [@bubley2023] was used to calculate the average relative abundance from 1990 -- 2022 of Red Snapper and Gag in each of the three geographic areas included in the MSE. 
